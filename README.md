...
<h1><img src="https://coe.gsa.gov/img/coe-logomark.svg" width="40px" align="top" alt="The Centers of Excellence Logo"> Centers of Excellence / Micro-purchase Threshold (MPT) procurements </h1>
...
## Workflow
When awarding a new MPT buy, these are the steps we follow:
...
* To submit their final deliverables, contractor should fork their public repo, and then create a pull request back to the master branch of their public repo with the deliverables added in `yyyy-mm-dd {{User-Story}}/Deliverables`.
...
## Participating
The requirements to participate are outlined in [PARTICIPATING.md](https://github.com/GSA/CoE-MPT/blob/master/PARTICIPATING.md).
...
* **Link to Issue:** [Issue number 1](https://github.com/GSA/CoE-MPT/issues/1)
